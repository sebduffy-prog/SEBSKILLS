...
→ `skill-creator` — turn it into a durable skill
...
All skills originate from [`anthropics/skills`](https://github.com/anthropics/skills) or [`obra/superpowers`](https://github.com/obra/superpowers).
